...
BOT_TOKEN = os.environ.get("BOT_TOKEN", None)
 ...
 class Config:
    ...
    APP_TITLE = os.environ.get("APP_TITLE", "PandaX_Userbot")
    APP_SHORT_NAME = os.environ.get("APP_SHORT_NAME", "PandaX_Userbot")
    APP_URL = os.environ.get("APP_URL", "https://telegram.dog/apiuserbutpetercord_bot")
    ...
    APP_DESCRIPTION = os.environ.get(
        "APP_DESCRIPTION",
        "created using https://telegram.dog/apiuserbutpetercord_bot"
    )
    #
