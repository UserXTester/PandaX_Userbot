...
# --------------------------------------------------------------------#
telegraph = Telegraph()
r = telegraph.create_account(short_name="PandaX_Userbot")
auth_url = r["auth_url"]
# --------------------------------------------------------------------#


TOKEN_FILE = "PandaVersion/auths/auth_token.txt"
...
async def _(e):
    ...
    await e.reply(
        "`Success!\nYou are all set to use Google Drive with PandaX_Userbot.`",
    ...
    await event.edit(
        ...
        buttons=[
            ...
            [
                ...
                Button.inline("MODULES", data="eaddon"),
            ],
            [
...
async def pmset(event):
    await event.edit(
        ...
        buttons=[
            [Button.inline("MODULES  Oɴ", data="edon")],
            [Button.inline("MODULES  Oғғ", data="edof")],
            [Button.inline("« Bᴀᴄᴋ", data="otvars")],
        ],
    )
...
async def eddon(event):
    ...
    await event.edit(
        "Done! MODULES has been turned on!!\n\n After Setting All Things Do Restart",
...
async def eddof(event):
    ...
    await event.edit(
        "Done! MODULES has been turned off!! After Setting All Things Do Restart",
        buttons=get_back_button("eaddon"),
    )
