...
PandaX_Userbot {petercordpanda_version},  by @diemmmmmmmmmm
"""
...
_start = [
    [
        ...
        Button.url("📣 CHANNEL 📣", url="https://t.me/UserbotTEAM_Tutorial"),
    ],
    [
...
async def timezone_(event):
    ...
    async with event.client.conversation(pru) as conv:
        await conv.send_message(
            "Berikan zona waktu anda dari list yang tersedia ini, [cek dari sini](http://www.timezoneconverter.com/cgi-bin/findzone.tzc)"
        )
