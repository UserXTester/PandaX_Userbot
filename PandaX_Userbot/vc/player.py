...
from pyrogram import filters, emoji, Client as PandaBotPy
...
@PandaBotPy.on_message(main_filter & current_vc & filters.regex("^(\\/|.)current$"))
...
@PandaBotPy.on_message(
    main_filter & self_or_contact_filter & filters.regex("^.joinvc$")
)
...
@PandaBotPy.on_message(main_filter & self_or_contact_filter & filters.regex("^.vc$"))
...
@PandaBotPy.on_message(main_filter & current_vc & filters.regex("^(\\/|.)repo$"))
