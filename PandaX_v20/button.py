"""
♨ Commands Available -
• `{i}botbutton text (optional -\n[button_text_1](https://t.me/TEAMSquadUserbotSupport)\n[button_text_2](https://t.me/TEAMSquadUserbotSupport))`
...
@ilhammansiz_cmd(pattern="botbutton")
